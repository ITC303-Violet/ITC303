...
package org.wikibooks.ssl;
 ...
 /*
 This class isn't ours. This is an explanation about why we added it, and 
 where we got it:
 
 SSLUtilities is a class I got from here: 
 
 https://en.wikibooks.org/wiki/WebObjects/Web_Services/How_to_Trust_Any_SSL_Certificate
 
 I added it because the Nintendo server doesn´t have a valid certificate, so you
 get a warning when entering it from the browser. I found this thanks to
 ...
 You can try to access this sample URL from your browser to see what
 I mean. It´s marked as a dangerous site, but it's clearly a Nintendo
 server URL:
 
 https://samurai.ctr.shop.nintendo.net/samurai/ws/US/platforms/?shop_id=1
