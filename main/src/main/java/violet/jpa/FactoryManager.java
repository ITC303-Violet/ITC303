...
public class FactoryManager {
	...
	private static ThreadLocal<Integer> entityManagerDepth = new ThreadLocal<Integer>() {
		@Override
	...
	private static ThreadLocal<Integer> transactionDepth = new ThreadLocal<Integer>() {
		@Override
		protected Integer initialValue() {
			return 0;
		}
	...
	public static void closeCommonEM() {
		if (entityManager.get() == null || !entityManager.get().isOpen())
			return;
